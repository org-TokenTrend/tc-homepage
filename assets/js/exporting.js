...
(function (c) {
    ...
    q(c, "Extensions/Exporting.js", [c["Core/Chart/Chart.js"], c["Mixins/Navigation.js"], c["Core/Globals.js"], c["Core/Options.js"], c["Core/Color/Palette.js"], c["Core/Renderer/SVG/SVGRenderer.js"], c["Core/Utilities.js"]], function (c, m, h, k, n, q, e) {
        var z = h.doc, G = h.isTouchDevice, B = h.win;
        k = k.defaultOptions;
        var x = e.addEvent, r = e.css, y = e.createElement, E = e.discardElement, A = e.extend, H = e.find,
            D = e.fireEvent,
            I = e.isObject, p = e.merge, F = e.objectEach, t = e.pick, J = e.removeEvent, K = e.uniqueKey;
        A(k.lang, {
        ...
        A(c.prototype, {
            sanitizeSVG: function (a, b) {
                ...
                var g = this, u = g.options.navigation, m = g.chartWidth, C = g.chartHeight, v = "cache-" + a, l = g[v],
                    w = Math.max(c, h);
                if (!l) {
            ...
            function () {
                ...
                function b(c) {
                    ...
                    if (1 === c.nodeType && -1 === m.indexOf(c.nodeName)) {
                        ...
                        if (h.isFirefox || h.isMS) for (var y in u) f(u[y], y); else F(u, f);
